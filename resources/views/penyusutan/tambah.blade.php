            ...
            <div class="container-fluid">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="/insertpeny" method="POST" enctype="multipart/form-data" id="penyusutan">
                      @csrf
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Id Penyusutan</label>
                          <div class="col-sm-10">
                            <input type="text" name="id_penyusutan" class="form-control" id="basic-default-name" placeholder="Masukkan id penyusutan.." />
                          </div>
                        </div>
                        <!-- <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Id Aset</label>
                          <div class="col-sm-10">
                            <input type="text" name="id_aset" class="form-control" id="basic-default-name" placeholder="Masukkan id penyusutan.." />
                          </div>
                        </div> -->
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-4">
                            ...
                            @foreach($asets as $aset)
                                <option value="{{ $aset->id_aset }}" data-biaya="{{ $aset->nilai }}">{{ $aset->nama_aset }}</option>
                            @endforeach
                            </select>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Biaya Perolehan</label>
                          <div class="col-sm-10">
                            <input type="text" name="biaya_perolehan" class="form-control" id="biaya_perolehan" placeholder="Otomatis terisi.."  readonly/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Nilai Residu</label>
                          <div class="col-sm-10">
                            <input type="text" name="nilai_residu" class="form-control" id="residu" placeholder="Masukkan nilai residu.." />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Umur Manfaat</label>
                          <div class="col-sm-10">
                            <input type="text" name="umur_manfaat" class="form-control" id="umur" placeholder="Masukkan umur manfaat.." />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Biaya Depresiasi Perolehan</label>
                          <div class="col-sm-10">
                            <input type="text" name="biaya_perolehanDep" class="form-control" id="biaya_perolehanDep" placeholder="(Biaya perolehan - nilai residu)/umur manfaat"  readonly/>
                          </div>
                        </div>
...
function confirmSubmit() {
    ...
    okButton.onclick = function() {
        ...
        document.getElementById("penyusutan").submit();
