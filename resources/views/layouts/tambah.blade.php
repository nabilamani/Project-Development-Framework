                    ...
                    <div class="card-body">
                      ...
                      @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="id_aset" class="form-control" id="basic-default-name" placeholder="Masukkan id aset.." />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Nama Aset</label>
                          <div class="col-sm-10">
                            <input type="text" name="nama_aset" class="form-control" id="basic-default-name" placeholder="Masukkan nama aset.." />
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3" style="margin-bottom: 10px;">
                          ...
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kondisi" id="Butuh Perbaikan" value="Butuh Perbaikan"/>
                            <label class="form-check-label" style="margin-right: 20px;" for="inlineRadio2">Butuh Perbaikan</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="kondisi" id="Rusak Total" value="Rusak Total"/>
                        ...
                        <div class="row mb-3" style="margin-bottom: 10px;">
                          ...
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="Hilang" value="Hilang"/>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="lokasi" class="form-control" id="basic-default-name" placeholder="Masukkan lokasi aset.." />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Nilai</label>
                          <div class="col-sm-4">
                            <input type="text" name="nilai" class="form-control" id="basic-default-name" placeholder="Masukkan nilai aset.." />
                          </div>
                          <label for="html5-number-input" class="col-md-2 col-form-label">Tahun</label>
                          <div class="col-md-4">
                            <input class="form-control" name="tahun_perolehan" type="number" value="" id="html5-number-input" min="1980" max="2100" placeholder="Masukkan tahun perolehan aset.."/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Deskripsi</label>
                          <div class="col-sm-10">
                            <textarea name="deskripsi" class="form-control" rows="3" id="comment" placeholder="Masukkan deskripsi aset.. (opt)"></textarea>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Foto</label>
                          <div class="col-sm-4">
                            <input class="form-control" type="file" name="gambar" id="gambar" style="height: 100%;"/>
                          </div>
                        </div>                        
