                    ...
                    <div class="card-body">
                      ...
                      @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="id_pemeliharaan" class="form-control" id="basic-default-name" placeholder="Masukkan id pemeliharaan.." />
                          </div>
                        </div>
                        <!-- <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="biaya_pemeliharaan" class="form-control" id="biaya_pemeliharaan" placeholder="Masukkan biaya pemeliharaan.." />
                          </div>
                        </div>
                        <div class="mb-3 row">
                          <label for="html5-date-input" class="col-md-2 col-form-label">Tanggal Pemeliharaan</label>
                          <div class="col-md-10">
                            <input class="form-control" name="tanggal_pemeliharaan" type="date" id="html5-date-input" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Keterangan</label>
                          <div class="col-sm-10">
                            <textarea name="keterangan" class="form-control" rows="3" id="comment" placeholder="Masukkan keterangan rincian pemeliharaan.."></textarea>
                          </div>
                        </div>
